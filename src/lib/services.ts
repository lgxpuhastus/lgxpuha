...
export const services: Record<string, ServiceData> = {
  'regular-cleaning': {
    ...
    pricing: [
      { type: 'Up to 30 m²', price: '60 EUR' },
      { type: '30–45 m²', price: '75 EUR' },
      { type: '45–60 m²', price: '90 EUR' },
      { type: '60–80 m²', price: '110 EUR' },
      { type: '80–100 m²', price: '130 EUR' },
      { type: '100 m²+', price: 'from 150 EUR' },
    ],
  ...
  'deep-cleaning': {
    ...
    pricing: [
      { type: 'Up to 30 m²', price: '120 EUR' },
      { type: '30–45 m²', price: '150 EUR' },
      { type: '45–60 m²', price: '200 EUR' },
      { type: '60–80 m²', price: '265 EUR' },
      { type: '80–100 m²', price: '330 EUR' },
      { type: '100 m²+', price: 'from 330 EUR' },
    ],
  ...
  'move-out-cleaning': {
    ...
    pricing: [
      { type: 'Up to 30 m²', price: '100 EUR' },
      { type: '30–45 m²', price: '145 EUR' },
      { type: '45–60 m²', price: '195 EUR' },
      { type: '60–80 m²', price: '260 EUR' },
      { type: '80–100 m²', price: '325 EUR' },
    ],
