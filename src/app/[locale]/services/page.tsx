...
const serviceData = [
  { key: 'regular', href: '/services/regular-cleaning', icon: Home, priceAmount: 70, image: '/images/kitchen-clean.jpg' },
  { key: 'deep', href: '/services/deep-cleaning', icon: Sparkles, priceAmount: 120, image: '/images/bathroom-clean.jpg' },
  { key: 'moveOut', href: '/services/move-out-cleaning', icon: Truck, priceAmount: 150, image: '/images/moveout-clean.jpg' },
